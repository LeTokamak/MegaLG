...
nuit_hDeb_Theo = datetime( ajd.year, ajd.month, ajd.day,  16, 00, tzinfo = HParis ) # datetime( ajd.year, ajd.month, ajd.day,  8, 00, tzinfo = HParis )
...
conseilLG_hFin = datetime( ajd.year, ajd.month, ajd.day, 17, 00, tzinfo = HParis ) # datetime( ajd.year, ajd.month, ajd.day, 14, 00, tzinfo = HParis )

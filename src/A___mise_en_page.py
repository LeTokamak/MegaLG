...
def strDate(date, type_format = 0):
    """
    type_format == 0 : Mardi_20_Avril_2021,
    type_format == 1 : Mardi_20_Avril
    type_format == 2 : Mar_20_Avr 
    type_format == 3 : _20_Avril_2021
    type_format == 4 : _20_Avril
    type_format == 5 : _20_04
    ...
    if   type_format == 0 :
        ...
        return f"{date.day} {mois(date.month)}"
